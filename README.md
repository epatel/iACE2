...
The emulator core, the screen, the on-screen keyboard and persistence all work on iOS and Android. Sound, the manual viewer and the drawer UI are next. [project-plan.md](project-plan.md) lists every phase and its state.
...
| ⏳ | Beeper sound, the manual with runnable examples, the drawer UI, `.TAP` import/export |
